...
### Introduction
- 서버 개발자 김윤겸입니다.
- 유지보수성 높은 코드를 작성하며, 코드 리뷰와 리팩토링을 통해 팀 전체의 코드 품질 향상에 기여합니다.
- 기술 문서와 지식 공유를 통해 팀의 생산성을 높입니다.
- 기획 단계부터 적극적으로 참여하여 기술적 관점의 인사이트를 제공합니다.
- 새로운 기술 도입에 열려있으며, 트레이드오프를 고려한 합리적 의사결정을 지향합니다.
...
- 방치형 키우기 게임
### 개발
- C#, .NET 8.0 기반의 게임 컨텐츠 개발
- 실시간 광장 서버 개발
- 실시간 레이드 서버 개발
- 코드 리팩토링
- JMeter 를 사용한 단위 테스트 및 부하 테스트
- 라이브 출시 직후 서버 안정화
- 기존 분산 서버당 동시 접속 부하 이슈 해결 (500명 -> 3000명)
- DB 설계 리팩토링
- Trade Off 공유
- 서버 비용 70% 절감
